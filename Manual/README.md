...
Documentation technique du projet, organisée par thème.
...
| Document | Contenu |
|----------|---------|
| [memory.md](memory.md) | Système de mémoire : 3 couches, retrieval hybride, consolidation, curiosity, ingestion de documents |
| [routing.md](routing.md) | Pipeline de routing : mots-clés, classifieur ML, LLM fallback, arbitrage, ré-entraînement |
